...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, ClientOptions = {}> = {
    meta: {
      modelProps: "user" | "userRole" | "admin" | "issuer" | "investor" | "authProvider" | "dIDWallet" | "refreshToken" | "wallet" | "kycVerification"
  ...
  export type kycVerificationSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    user?: boolean | kycVerification$userArgs<ExtArgs>
  ...
  export interface Prisma__kycVerificationClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    user<T extends kycVerification$userArgs<ExtArgs> = {}>(args?: Subset<T, kycVerification$userArgs<ExtArgs>>): Prisma__UserClient<$Result.GetResult<Prisma.$UserPayload<ExtArgs>, T, "findUniqueOrThrow"> | null, null, ExtArgs>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  interface kycVerificationFieldRefs {
    ...
    readonly applicantId: FieldRef<"kycVerification", 'String'>
    readonly externalUserId: FieldRef<"kycVerification", 'String'>
    readonly inspectionId: FieldRef<"kycVerification", 'String'>
    readonly correlationId: FieldRef<"kycVerification", 'String'>
    readonly type: FieldRef<"kycVerification", 'String'>
    readonly reviewStatus: FieldRef<"kycVerification", 'String'>
    readonly reviewResult: FieldRef<"kycVerification", 'String'>
    readonly createdAt: FieldRef<"kycVerification", 'DateTime'>
    readonly modifiedAt: FieldRef<"kycVerification", 'DateTime'>
    readonly rawData: FieldRef<"kycVerification", 'String'>
    readonly userId: FieldRef<"kycVerification", 'Int'>
    readonly signatureValid: FieldRef<"kycVerification", 'Boolean'>
    readonly webhookType: FieldRef<"kycVerification", 'String'>
    readonly eventTimestamp: FieldRef<"kycVerification", 'DateTime'>
    readonly processingStatus: FieldRef<"kycVerification", 'String'>
    readonly retryCount: FieldRef<"kycVerification", 'Int'>
    readonly errorMessage: FieldRef<"kycVerification", 'String'>
  }
   ...
   */
  export type kycVerification$userArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the User
     */
    select?: UserSelect<ExtArgs> | null
  ...
  export type kycVerificationWhereInput = {
    ...
    applicantId?: StringFilter<"kycVerification"> | string
    externalUserId?: StringFilter<"kycVerification"> | string
    inspectionId?: StringFilter<"kycVerification"> | string
    correlationId?: StringNullableFilter<"kycVerification"> | string | null
    type?: StringFilter<"kycVerification"> | string
    reviewStatus?: StringFilter<"kycVerification"> | string
    reviewResult?: StringNullableFilter<"kycVerification"> | string | null
    createdAt?: DateTimeFilter<"kycVerification"> | Date | string
    modifiedAt?: DateTimeFilter<"kycVerification"> | Date | string
    rawData?: StringFilter<"kycVerification"> | string
    userId?: IntNullableFilter<"kycVerification"> | number | null
    signatureValid?: BoolFilter<"kycVerification"> | boolean
    webhookType?: StringNullableFilter<"kycVerification"> | string | null
    eventTimestamp?: DateTimeNullableFilter<"kycVerification"> | Date | string | null
    processingStatus?: StringNullableFilter<"kycVerification"> | string | null
    retryCount?: IntFilter<"kycVerification"> | number
    errorMessage?: StringNullableFilter<"kycVerification"> | string | null
  ...
  export type kycVerificationOrderByWithRelationInput = {
    ...
    webhookType?: SortOrderInput | SortOrder
  ...
  export type kycVerificationScalarWhereWithAggregatesInput = {
    ...
    applicantId?: StringWithAggregatesFilter<"kycVerification"> | string
    externalUserId?: StringWithAggregatesFilter<"kycVerification"> | string
    inspectionId?: StringWithAggregatesFilter<"kycVerification"> | string
    correlationId?: StringNullableWithAggregatesFilter<"kycVerification"> | string | null
    type?: StringWithAggregatesFilter<"kycVerification"> | string
    reviewStatus?: StringWithAggregatesFilter<"kycVerification"> | string
    reviewResult?: StringNullableWithAggregatesFilter<"kycVerification"> | string | null
    createdAt?: DateTimeWithAggregatesFilter<"kycVerification"> | Date | string
    modifiedAt?: DateTimeWithAggregatesFilter<"kycVerification"> | Date | string
    rawData?: StringWithAggregatesFilter<"kycVerification"> | string
    userId?: IntNullableWithAggregatesFilter<"kycVerification"> | number | null
    signatureValid?: BoolWithAggregatesFilter<"kycVerification"> | boolean
    webhookType?: StringNullableWithAggregatesFilter<"kycVerification"> | string | null
    eventTimestamp?: DateTimeNullableWithAggregatesFilter<"kycVerification"> | Date | string | null
    processingStatus?: StringNullableWithAggregatesFilter<"kycVerification"> | string | null
    retryCount?: IntWithAggregatesFilter<"kycVerification"> | number
    errorMessage?: StringNullableWithAggregatesFilter<"kycVerification"> | string | null
  }
  ...
  export type kycVerificationUpdateInput = {
    ...
    reviewResult?: NullableStringFieldUpdateOperationsInput | string | null
    ...
    webhookType?: NullableStringFieldUpdateOperationsInput | string | null
    ...
    user?: UserUpdateOneWithoutKyc_verificationsNestedInput
  }
  ...
  export type UserUpdateOneWithoutKyc_verificationsNestedInput = {
    create?: XOR<UserCreateWithoutKyc_verificationsInput, UserUncheckedCreateWithoutKyc_verificationsInput>
    connectOrCreate?: UserCreateOrConnectWithoutKyc_verificationsInput
